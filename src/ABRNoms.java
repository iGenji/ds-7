public class ABRNoms {
	...
	/**
	 * supprime le plus "petit" nom (selon ordre alphabetique)
	 * @return le plus "petit" nom ou null si l'arbre est vide
	 */
	public String supprimeMin(){
		if(estVide())
			return null;
		if(filsGauche().estVide()){
			String nomARenvoyer = racine.element();
			racine = this.filsDroit().racine;
			return nomARenvoyer;
		}
